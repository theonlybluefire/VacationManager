...
public class main {
    public static void main(String[] args) {
        ...
        System.out.println("When do you have to book vacation (Format : 01/12 - 2/1 , 02/12 - 3/1  )");
        //readout ouput
        */
        ...
        for(int i = (startDayOfYear-1); i < 365;i++) {
            if(i%7 == 5 || i%7 == 6) { //check for saturday or sunday
                Day day = new Day(false, currentDay, currentMonth, currentYear); 
            }
            if(currentDay == 31 && ( currentMonth==1 ||currentMonth==3 || currentMonth == 5 || currentMonth==7 || currentMonth==10 || currentMonth==12 ) ) {
                currentMonth++;
                currentDay=1;
            }
            ...
            Day day = new Day(true, currentDay, currentMonth, currentYear);
            days.add(day);
            currentDay++;
        }
